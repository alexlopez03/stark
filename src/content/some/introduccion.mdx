---
pid: 3bf7b1b4-36e7-4639-aec8-ad563f0a0ffb
title: Some:_Introduction
description: Welcome to the Next.js Documentation.
thumbnail: https://cdn.dribbble.com/userupload/9796592/file/still-53c58d84b1bfeec724af8375e8b6d1f1.png
---
...
<math eq="\log\prod^N_{i}x_{i}=\sum^N_i\log{x_i}" />

<Equation math="\log\prod^N_{i}x_{i}=\sum^N_i\log{x_i}" />
